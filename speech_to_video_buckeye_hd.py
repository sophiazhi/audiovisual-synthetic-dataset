...
if __name__ == "__main__":
    ...
    for audio_path in tqdm(audio_paths):
        ...
        subprocess.run(f'ffmpeg -f lavfi -t 0.5 -i anullsrc=channel_layout=mono:sample_rate=44100 -i {audio_global_path} -ar 44100 -filter_complex "[0:a][1:a][0:a]concat=n=3:v=0:a=1" {input_audio_path}', shell=True)
        ### END NEW
